...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "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", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "DPROSAN", lambda m: self.strings("cfg_gh_user", m),
            "GH_REPO", "UserBot", lambda m: self.strings("cfg_gh_repo", m))
